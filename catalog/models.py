...
class Book(models.Model):
    ...
    cover_image = models.ImageField(upload_to='covers/', blank=True, null=True, help_text='Couverture du livre')
...
class Author(models.Model):
    ...
    bio = models.TextField(max_length=1000, help_text='Entrer une petite bio')
    class Meta:
